...
export const metadata:Metadata={title:'Unsolicited Advice | Reviews that help',description:'Find local businesses through honest community reviews.',manifest:'/manifest.json'};
