...
export const metadata:Metadata={title:'My Two Sense | Reviews that help',description:'Find local businesses through honest community reviews.',manifest:'/manifest.json'};
